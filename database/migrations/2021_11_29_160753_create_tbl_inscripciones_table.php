...
class CreateTblInscripcionesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_inscripciones', function (Blueprint $table) {
            ...
            $table->foreign('FK_SOLICITADO', 'mae_persona_solicitado_tbl_inscripcion_fk')->references('ID_PERSONA')->on('mae_personas');
            $table->foreign('FK_APROBADO', 'mae_persona_aprobado_tbl_inscripcion_fk')->references('ID_PERSONA')->on('mae_personas');
